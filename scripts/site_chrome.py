...
def header(current='home', prefix=''):
  ...
  <div class="wrap site-inner">
    ...
    <div class="site-navigation" id="site-navigation">
      ...
      <div class="site-actions"><a class="site-sales" href="{prefix}sales.html"{current_attr('sales')}>Contact sales</a><a class="site-demo" href="{prefix}app.html">Try the demo <span aria-hidden="true">↗</span></a></div>
    </div>
  </div>
</header>'''
...
def footer(prefix=''):
    return f'''<footer class="site-footer"><div class="wrap"><div class="foot-grid"><div class="foot-brand"><a href="{prefix}index.html" aria-label="Mach 1 home"><img class="brand-logo" src="{prefix}assets/brand/mach1-logo-white.png" alt="Mach 1" height="28"></a><p>AI agents for support and sales.<br>Your team stays in control.</p></div><nav aria-label="Product"><h2 class="foot-h">Product</h2><a href="{prefix}product.html">Product overview</a><a href="{prefix}product.html#capabilities">Capabilities</a><a href="{prefix}index.html#integrations">Integrations</a><a href="{prefix}app.html">Try the demo</a></nav><nav aria-label="Discover"><h2 class="foot-h">Discover</h2><a href="{prefix}index.html#customers">Customer stories</a><a href="{prefix}updates.html">Product updates</a><a href="{prefix}index.html#faq">Frequently asked questions</a></nav><nav aria-label="Connect"><h2 class="foot-h">Connect</h2><a href="{prefix}sales.html">Contact sales</a><a href="mailto:hello@mach1ai.com">Get in touch</a></nav></div><div class="bottom-bar"><p>© 2026 Mach 1 AI, Inc.</p><a href="#top">Back to top <span aria-hidden="true">↑</span></a></div></div></footer>'''
